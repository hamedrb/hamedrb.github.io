  ...
  <div class="content">
    ...
    <div class="description">
        ...
        <style>
          ...
          /* Clean 3-column architectural layout */
          .hex-grid-container {
            display: grid;
          ...
          /* Modular Card design inspired by premium dark themes */
          .tech-hex-card {
          ...
          /* Subtle background ambient details mimicking data visualization flow */
          ...
          /* Interactive glowing hover effects */
          .tech-hex-card:hover {
          ...
          /* Layout structure for text inside modules */
          .hex-icon {
            font-size: 1.4rem;
            min-width: 32px;
            height: 32px;
